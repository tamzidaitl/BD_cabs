        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinFare = table.Column<int>(type: "integer", nullable: true),
                    ...
                    ApplicableCities = table.Column<List<Guid>>(type: "uuid[]", nullable: false),
                    ApplicableRoles = table.Column<List<string>>(type: "text[]", nullable: false),
                    CostBorneBy = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    FirstRideOnly = table.Column<bool>(type: "boolean", nullable: false),
